...
public class BookAppointmentActivity extends AppCompatActivity {
  ...
  private Button dateButton, timeButton, btnBook,btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1 = findViewById(R.id.editTextBMBPinCode);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmentExist(username,title+ "=>"+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    ...
                    Toast.makeText(getApplicationContext(), "Your Appointment is done successfuly", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(BookAppointmentActivity.this,HouseActivity.class));
                }
            }
        });
    }
